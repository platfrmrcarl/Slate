...
The baseline theme `slate-default` exposes ~25 customization tokens and 4 template variants (`page`, `post`, `archive`, `home`) so the runtime path covers most ordinary brand changes.
...
| `src/themes/seed.ts`                          | Idempotent seeder that inserts `slate-default`                                         |
| `src/themes/seed.test.ts`                     | Tests                                                                                |
| `themes/slate-default/manifest.json`            | Baseline theme manifest                                                              |
| `themes/slate-default/index.ts`                 | Theme module: exports primitives, templates, tokens                                  |
| `themes/slate-default/components/Layout.tsx`    | Site shell (nav, footer, token injection)                                            |
| `themes/slate-default/components/Heading.tsx`   | Heading primitive                                                                    |
| `themes/slate-default/components/Paragraph.tsx` | Paragraph primitive                                                                  |
| `themes/slate-default/components/Button.tsx`    | Button primitive                                                                     |
| `themes/slate-default/components/Hero.tsx`      | Hero primitive                                                                       |
| `themes/slate-default/components/Image.tsx`     | Theme-styled image wrapper around media `<Image>`                                    |
| `themes/slate-default/templates/page.tsx`       | Page template                                                                        |
| `themes/slate-default/templates/post.tsx`       | Post template                                                                        |
| `themes/slate-default/templates/home.tsx`       | Home template                                                                        |
| `themes/slate-default/templates/archive.tsx`    | Archive template                                                                     |
| `themes/slate-default/tokens.css.ts`            | Token → CSS variable serializer                                                      |
...
- Create: `themes/slate-default/manifest.json` (skeleton — fleshed out in Task 7)
- Create: `themes/slate-default/index.ts` (skeleton)
...
`themes/slate-default/manifest.json`:
...
- [ ] **Step 3: Create skeleton `themes/slate-default/index.ts`**
...
```bash
mkdir -p themes/slate-default/components themes/slate-default/templates
for f in Layout Heading Paragraph Button Hero Image; do
  cat > "themes/slate-default/components/$f.tsx" <<EOF
...
for f in page post archive home; do
  cat > "themes/slate-default/templates/$f.tsx" <<EOF
import type { ReactNode } from "react";
...
const REGISTRY: Record<string, { slug: string; loader: Loader }> = {
  "slate-default": {
    slug: "slate-default",
    loader: () => import("@/../themes/slate-default"),
  },
...
Update `tsconfig.json` paths if `@/../themes/slate-default` doesn't resolve (in foundation `@/*` maps to `src/*`). Use a relative import instead:
...
```bash
git add src/themes/registry.ts src/themes/registry.test.ts themes/slate-default tsconfig.json
git commit -m "feat(themes): compile-time registry + slate-default skeleton"
```
...
## Task 6: Seed slate-default at boot (TDD)
...
git commit -m "feat(themes): idempotent seeder for slate-default"
```

---

## Task 7: Flesh out the slate-default theme

**Files:**

- Modify: `themes/slate-default/components/Layout.tsx`
- Modify: `themes/slate-default/components/Heading.tsx`
- Modify: `themes/slate-default/components/Paragraph.tsx`
- Modify: `themes/slate-default/components/Button.tsx`
- Modify: `themes/slate-default/components/Hero.tsx`
- Modify: `themes/slate-default/components/Image.tsx`
- Modify: `themes/slate-default/templates/page.tsx`
- Modify: `themes/slate-default/templates/post.tsx`
- Modify: `themes/slate-default/templates/home.tsx`
- Modify: `themes/slate-default/templates/archive.tsx`
- Create: `themes/slate-default/tokens.css.ts`

- [ ] **Step 1: Token serializer**

`themes/slate-default/tokens.css.ts`:
...
`themes/slate-default/components/Layout.tsx`:
...
`themes/slate-default/components/Heading.tsx`:
...
`themes/slate-default/components/Paragraph.tsx`:
...
`themes/slate-default/components/Button.tsx`:
...
`themes/slate-default/components/Hero.tsx`:
...
`themes/slate-default/components/Image.tsx`:
...
`themes/slate-default/templates/page.tsx`:
...
`themes/slate-default/templates/post.tsx`:
...
`themes/slate-default/templates/archive.tsx`:
...
`themes/slate-default/templates/home.tsx`:
...
```bash
git add themes/slate-default
git commit -m "feat(themes/slate-default): tokens, layout, primitives, templates"
```
...
Expected: server boots; first request seeds `slate-default` and activates it.

- [ ] **Step 2: Customizer smoke**

1. Sign in as admin.
2. Visit `/admin/themes` — `slate-default` is listed as Active.
