  ...
  return (
    <nav className="border-b border-[var(--slate-border)]">
      <div className="mx-auto flex max-w-[1100px] items-center justify-between px-6 py-4">
        <Link
          href={"/" as Route}
          className="marketing-serif text-lg tracking-tight text-[var(--slate-fg)]"
        >
        ...
        <div className="flex items-center gap-6 text-[13px] text-[var(--slate-fg-muted)]">
          <a href="#features" className="hover:text-[var(--slate-fg)]">
            Features
          </a>
          <Link href={"/products" as Route} className="hover:text-[var(--slate-fg)]">
            Pricing
          </Link>
          <a
            href={WIKI_URL}
          ...
          <Link href={"/sign-in" as Route} className="hover:text-[var(--slate-fg)]">
            Sign in
          </Link>
          <Link
