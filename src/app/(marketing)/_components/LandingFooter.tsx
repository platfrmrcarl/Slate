    ...
    <footer className="border-t border-[var(--slate-border)] px-6 py-6 font-mono text-[11px] text-[var(--slate-fg-subtle)]">
      <div className="mx-auto flex max-w-[1100px] flex-wrap items-center justify-between gap-3">
        ...
        <nav className="flex items-center gap-4">
          <Link href={"/privacy" as Route} className="hover:text-[var(--slate-fg-muted)]">
            Privacy
          </Link>
          <Link href={"/terms" as Route} className="hover:text-[var(--slate-fg-muted)]">
            Terms
          </Link>
          <Link href={"/status" as Route} className="hover:text-[var(--slate-fg-muted)]">
            Status
          </Link>
          <a
